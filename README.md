...
## Undergraduate Courses
  ...
  * [MAE 375 (Kinematics and Dynamics of Mechanisms - MATLAB)](#4-mae-375-kinematics-and-dynamics-of-mechanisms---matlab)
  
  * [MAE 376 (Modeling and Analysis of Dynamic Systems - MATLAB)](#5-mae-376-modeling-and-analysis-of-dynamic-systems---matlab)
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/232ea38d-4dd4-4689-a13e-4e857cbd2400" height="400">
</p>
...
<img src="https://github.com/user-attachments/assets/2a7fc998-78ad-4aa5-bc93-5f46688705a9" alt="Proj 2 Moneyshot" width="850" height="500">
...
| :------------: | :-------------: | :-------------: | :-------------: |
| 1 | Three Card Monte | `Python Basics` `Input/Output` `Coding Standards` | ![images](https://user-images.githubusercontent.com/84933358/221105590-f2b8904d-a965-4f67-9cb4-775ad828a7d2.jpg) |
| 2 | Rock Paper Scissors | `Functions` `Arrays` `Input Validation` | ![step4](https://user-images.githubusercontent.com/84933358/221104686-be90b143-a964-4d26-9c09-3fbd73af305d.gif) |
...
#### 2. MAE 205 (Computer Methods - MATLAB) Classwork/Homework
Exhibits Labs 1-10, as well as unique problems given as extra credit 

------

#### 3. MAE 305 (Numerical Methods - MATLAB)
...
| Chapter No. | Name | Key Topics | Figure |
| :------------: | :-------------: | :-------------: | :-------------: |
| 4 | Position Analysis | `Displacement` `Transimmion Angles` `Linkage Types` | ![Position_Analysis](https://user-images.githubusercontent.com/84933358/218877303-1493b966-fd76-4a18-bc4b-6e4b16a8243c.jpg) |
| 5 | Analytical Linkage Synthesis | `Two-Position` `Three-Position` `Optimization Methods` | ![3Pos](https://user-images.githubusercontent.com/84933358/218875739-3dfe6d11-a41f-430b-8cf1-73ef212a60e2.png) |
...
| Chapter No. | Name | Key Topics | Figure |
| :------------: | :-------------: | :-------------: | :-------------: |
| 2 | Complex Analysis| `Laplace Transformation` `Differential Equation` `Unit-Step/Ramp/Pulse/Impulse` `Initial/Final Value Theorem`| ![img2B](https://user-images.githubusercontent.com/84933358/218881307-c9313580-4178-4468-aa61-a0cb9c78d008.gif) |
| 3 | Matrix Analysis | `Gauss Elimination` `Cramer's Rule` `Eigenvalues` | ![eig12](https://user-images.githubusercontent.com/84933358/218882468-b02614e0-8fa7-401e-9599-b184072064ec.png) |
| 4 | System Model Representation | `Simulink` `State-Space Form` `I/O Equation` `Transfer Function` `Block Diagram` `Linearization` | ![model-based-design-simple-system](https://user-images.githubusercontent.com/84933358/218882782-9397782a-6401-488b-acaf-c0dc077c4baa.png) |
| 5 | Mechanical Systems |`Spring and Dampers` `Translational Systems` `Rotational Systems` `Mixed Systems: Translation and Rotation` `Gear-Train Systems` | ![Mech](https://user-images.githubusercontent.com/84933358/218883927-7953b4ff-1205-4071-97cd-b4aa469029ce.png) |
| 6 | Electrical, Electronic, and Electromechanical System | `Circuits` `Kirchhoff's Voltage/Current Law` `Op-Amps` `Impedance Methods` `System Modeling with Simulink & Simscape`| ![Elec](https://user-images.githubusercontent.com/84933358/218884632-07aba22d-8a69-4aee-806d-14dec354ed51.png) |
| 7 | Fluid and Thermal Systems | `Pnuematics` `Hydraulic Capacitance/Resistance` `Thermal Systems` `System Modeling with Simulink & Simscape` | ![2tank_level](https://user-images.githubusercontent.com/84933358/218891684-9d461721-0145-4366-a0e2-38968de9c655.png) |
...
| :------------: | :-------------: | :-------------: | :-------------: |
| 3 | Dynamic Response | `Convolution` `Partial-Fraction Expansion` `Time-Domain Specifications` | ![time_domain](https://user-images.githubusercontent.com/84933358/219851414-46716fb9-2328-486e-aac2-e7b45980ba6a.jpg) |
| 4 | Feedback Analysis | `Stability` `Tracking` `Regulation` `Sensitivity` `Steady-State Error` `Disturbance Rejection` `Feedforward` `PID Control` `Digital Control` | ![PID](https://user-images.githubusercontent.com/84933358/219851573-56d03123-cf7a-49ce-8260-022821fa2981.png) |
| 5 | Root-Locus Design |`Lag/Lead/Notch Compensation` `Analog/Digital Implementations` `Root Locus Rules/Properties` |![RootLoc](https://user-images.githubusercontent.com/84933358/219851625-4dd75a98-5bf9-47e1-8470-76cb9f92bde2.png) |
| 6 | Frequency Response Design | `Nyquist/Bode Plot` `Stability Margins` `Gain-Phase Relationship` `PD vs. PI vs. PID Compensation` | ![Nyq](https://user-images.githubusercontent.com/84933358/219851704-3317e59d-2a59-42e9-9a71-230666579bef.png) |
...
| :------------: | :-------------: | :-------------: |
| 1 | Salary Records | ![AramisK_Projet1_ConsoleScreenshot](https://user-images.githubusercontent.com/84933358/219852370-c774beb2-e878-409e-bab6-7b49e22d360b.png) |
| 2 | Student Grading System | ![AK_Project2_Grade 'A'](https://user-images.githubusercontent.com/84933358/219852443-10221654-7118-4ec1-a9be-e7624f56258b.png) |
| 3 | Employee Monthly Paycheck | ![Project 3_Console Ouput](https://user-images.githubusercontent.com/84933358/219852456-e228d8a4-4ed3-4460-b619-dc6de200d55e.png) |
| 4 | Quadratic Equation Algorithm | ![Real_Solutions](https://user-images.githubusercontent.com/84933358/219852480-9be0bf06-0d97-4e72-91c0-a283001756ae.png) |
| 5 | File IO to Console | ![Proj5_SS_console](https://user-images.githubusercontent.com/84933358/219852506-8c61e92f-ad40-4b0d-a7ae-1c987d39519c.png) |
| 6 | USPS ZipCode to BarCode | ![Project6_BarcodeOutput](https://user-images.githubusercontent.com/84933358/219852519-3408529b-5b5e-4d55-b48f-dcf8fbd70af0.png) |
| 7 | Election Results | ![Project7_Console Output](https://user-images.githubusercontent.com/84933358/219852545-30409412-7f8c-4416-9359-9156f6cd5c1a.png) |
| 8 | Automated Restaurant Billing System | ![Kelkelyan_CS11_Project8_ConsoleOutput1](https://user-images.githubusercontent.com/84933358/219852591-7dc4407d-0fee-4de0-bba1-4d53a0f347ce.png) |
| 9 | Roman Numeral to Positive Integer | ![Kelkelyan_CS11_Project9_ConsoleOutput1](https://user-images.githubusercontent.com/84933358/219852610-5e3ca0a5-fa43-42a0-b893-371581c10d62.png) |
